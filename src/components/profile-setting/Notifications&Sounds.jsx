...
function NotificationsAndSounds({settingSelected, setSettingSelected}) {
  return (
    <div className={classNames(' bg-white h-full w-full m-0 absolute inset-0 p-4 transition-all duration-500', {
        "visible": settingSelected === "notifications & sounds",
        ...
        <div className='flex items-end gap-4 py-2'>
            ...
            <h3 className=' text-lg text-black'>notifications & sounds</h3>
